...
{
    /// <summary>
    /// Service for dealing with log entries that were logged during before the AI logger was initialized.
    /// </summary>
    public interface IPreviousLogEntriesCollector : IDependency
    {
        /// <summary>
        /// Re-logs those log entries that where created during application start, before the AI 
        /// appender was registered.
        /// </summary>
        void ReLogPreviousLogEntries();
    }


    public class PreviousLogEntriesCollector : IPreviousLogEntriesCollector
    {
        public ILogger Logger { get; set; }


        public PreviousLogEntriesCollector()
        {
            Logger = NullLogger.Instance;
        }


        public void ReLogPreviousLogEntries()
        {
